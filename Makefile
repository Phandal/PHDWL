...
install: dwl
	...
	cp -f scripts/dwl_bar $(DESTDIR)$(PREFIX)/bin
	chmod 755 $(DESTDIR)$(PREFIX)/bin/dwl_bar
	cp -f scripts/launch_dwl $(DESTDIR)$(PREFIX)/bin
	chmod 755 $(DESTDIR)$(PREFIX)/bin/launch_dwl
